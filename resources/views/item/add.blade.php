...
<div class="flex flex-col w-full pb-5 mx-auto px-6 max-w-400 gap-6">
    ...
    <div class="flex flex-col md:flex-row gap-6 items-stretch w-full">
          ...
          <div class="flex-1 flex flex-col gap-1">
            ...
            <div class="w-full h-8 rounded-xl border border-gray-300 flex items-center justify-between px-3 text-xs text-gray-600 bg-[#E5E9F0]/40">
              <input
                ...
                class="bg-transparent border-none outline-none text-xs text-gray-700 w-full h-full placeholder-gray-400"
              />
              <span class="opacity-40 text-[10px] flex flex-col leading-none select-none">▲▼</span>
            </div>
          </div>
      ...
      <label class="w-full md:w-52 border border-gray-300 rounded-2xl p-4 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-gray-50/50 transition-colors gap-2 select-none">
        ...
        <div class="text-[10px] leading-tight text-gray-500">
          ...
          <p class="font-bold text-[#365194] flex items-center justify-center gap-1">
            Browse image
          </p>
        </div>
      </label>
  ...
  </div> <div class="card bg-[#F8F9FB] text-black w-full border-2 border-gray-300 rounded-2xl flex flex-col p-6 gap-4">
    ...
    <div class="flex flex-col sm:flex-row gap-x-6 gap-y-3 w-full">
      <div class="flex-1 flex flex-col gap-1 text-right">
        ...
        <div class="w-full h-8 rounded-xl border border-gray-300 flex items-center justify-between px-3 bg-[#E5E9F0]/40">
          ...
          />
<select
  style="background-image: url('/up.png'); background-size: 15px 15px; background-position: right 4px center;"
  class="appearance-none border border-gray-400/50 rounded px-1.5 py-0.5 bg-transparent text-[10px] font-bold text-gray-700 cursor-pointer outline-none text-center pr-5 bg-no-repeat"
>
...
>
      ...
      <div class="flex-1 flex flex-col gap-1 text-right">
        ...
        <div class="w-full h-8 rounded-xl border border-gray-300 flex items-center justify-between px-3 bg-[#E5E9F0]/40">
          <input
            ...
            class="bg-transparent border-none outline-none text-xs text-gray-700 w-full h-full placeholder-gray-400"
          />
          <div class="flex items-center gap-1 border border-gray-400/50 rounded px-1.5 py-0.5 bg-transparent text-[10px] font-bold text-gray-700 cursor-pointer select-none">
            <span>In</span> <span class="text-[8px] opacity-70">▼</span>
          </div>
        </div>
        <span class="text-[9px] text-gray-600 font-medium">Select Unit in which all the dimensions are</span>
      </div>
  ...
  </div> <div class="w-full flex justify-end items-center gap-3 mt-1">
    <button class="h-8 px-6 rounded-xl border border-gray-300 bg-white text-xs font-bold text-gray-700 hover:bg-gray-50 transition-colors">
      Cancel
    </button>
    <button class="h-8 px-6 rounded-xl border border-gray-300 bg-white text-xs font-bold text-gray-700 hover:bg-gray-50 transition-colors">
      Draft
    </button>
    <button class="h-8 px-6 rounded-xl bg-black text-xs font-bold text-white hover:bg-gray-800 transition-colors">
      Add Product
    </button>
  </div>
